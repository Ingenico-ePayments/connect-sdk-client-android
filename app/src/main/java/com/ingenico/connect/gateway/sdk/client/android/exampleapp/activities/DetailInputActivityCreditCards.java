...
import com.ingenico.connect.gateway.sdk.client.android.exampleapp.exception.IinStatusNotKnownException;
import com.ingenico.connect.gateway.sdk.client.android.exampleapp.render.iinlookup.IinLookupTextWatcher;
import com.ingenico.connect.gateway.sdk.client.android.exampleapp.render.persister.IinDetailsPersister;
...
import com.ingenico.connect.gateway.sdk.client.android.exampleapp.view.detailview.DetailInputViewCreditCard;
import com.ingenico.connect.gateway.sdk.client.android.exampleapp.view.detailview.DetailInputViewCreditCardImpl;
...
public class DetailInputActivityCreditCards extends DetailInputActivity
    ...
    private void retrieveNewPaymentProduct(String paymentProductId) {
        if (paymentProductId.equals(com.ingenico.connect.gateway.sdk.client.android.sdk.configuration.Constants.PAYMENTPRODUCTID_BanContact)) {
