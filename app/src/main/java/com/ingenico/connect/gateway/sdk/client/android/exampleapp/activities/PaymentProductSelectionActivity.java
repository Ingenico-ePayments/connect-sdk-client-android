...
import com.ingenico.connect.gateway.sdk.client.android.exampleapp.configuration.CheckCommunication;
import com.ingenico.connect.gateway.sdk.client.android.exampleapp.configuration.Constants;
import com.ingenico.connect.gateway.sdk.client.android.exampleapp.model.MerchantAction;
import com.ingenico.connect.gateway.sdk.client.android.exampleapp.model.ShoppingCart;
import com.ingenico.connect.gateway.sdk.client.android.exampleapp.util.GooglePay;
import com.ingenico.connect.gateway.sdk.client.android.exampleapp.view.selectionview.ProductSelectionView;
import com.ingenico.connect.gateway.sdk.client.android.exampleapp.view.selectionview.ProductSelectionViewImpl;
import com.ingenico.connect.gateway.sdk.client.android.sdk.Util;
import com.ingenico.connect.gateway.sdk.client.android.sdk.asynctask.BasicPaymentItemsAsyncTask.OnBasicPaymentItemsCallCompleteListener;
...
import com.ingenico.connect.gateway.sdk.client.android.sdk.asynctask.PaymentProductGroupAsyncTask.OnPaymentProductGroupCallCompleteListener;
...
import com.ingenico.connect.gateway.sdk.client.android.sdk.session.SessionEncryptionHelper;
                ...
                switch (resultCode) {
                    case RESULT_OK:
                        ...
                        try {
                            ...
                            paymentRequest.setValue(com.ingenico.connect.gateway.sdk.client.android.sdk.configuration.Constants.GOOGLE_PAY_TOKEN_FIELD_ID, encryptedPaymentData);
